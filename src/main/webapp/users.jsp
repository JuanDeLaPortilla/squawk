...
<head>
    ...
    <!-- Conexiones con CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/a-style-listas.css?v=1.73">
...
<script src="${pageContext.request.contextPath}/js/main.js?v=1.1"></script>
